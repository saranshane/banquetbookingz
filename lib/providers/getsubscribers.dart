...
class UserNotifier extends StateNotifier<SubscriptionModel> {
  UserNotifier() : super(SubscriptionModel());
...
final getSubProvider =
    StateNotifierProvider<UserNotifier, SubscriptionModel>((ref) {
  return UserNotifier();
});
